...
const COIN_URL = import.meta.env.VITE_COIN_URL;
...
export default function CoinDetailPage() {
  ...
  useEffect(() => {
    const fetchCoin = async () => {
      try {
        const res = await fetch(`${COIN_URL}/${id}`);
  ...
  return (
    <div className="coin-details-container">
      ...
      <h1 className="coin-details-tittle">
      ...
      {!loading && !error && (
        <>
          ...
          ></img>
          <p>{coin.description.en.split(". ").slice(0, 2).join(". ") + ". "}</p>
